...
<html lang="en">
  <head>
    ...
    table td.textologo {text-align: center;  font-weight: 400; height: 65px; background: #ffffff url('http://sistemas.oplever.org.mx/poa2019/images/logoople.jpg') no-repeat left top; width: 980px; font-size: 14px;}
