...
<style>
  ...
  <tr class="gris">
    ...
    @foreach($padre as $kpp => $padres)
      ...
      <table class="saltar" border="0" align="center" width="100%">
        <tr style="background:#fff; height:75px;">
          <th colspan="4" style="font-size: 16px;">
          ORGANISMO PÚBLICO LOCAL ELECTORAL <br> Programa Operativo Anual 2020
          </th>
  ...
  <table class="table btable" border="1" align="center" cellpadding="5px" 
  style="margin-top: -1px; width:100%;page-break-after: always;">
