...
<img class="logo" src="{{ asset('images/logosipseir.png') }}" alt="SIPSEI" title="logo SIPSEI" width="85" height="30" style="background-color: #343a40; border-radius: 5px;margin-top: 10px;padding: 0 3px;"></p>
