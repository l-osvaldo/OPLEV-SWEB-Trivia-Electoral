 ...
 function getErrVJS(ele){
      ...
      for (var i = 0; i < ele.length; i++) {
        var mapObj = { 
          ...
          document.getElementById('error-'+ele[i].getAttribute('data-group')) && 
          document.getElementById('error-'+ele[i].getAttribute('data-group')).textContent === '' ? 
          document.getElementById('error-'+ele[i].getAttribute('data-group')).textContent=messagesErrVjs[ele[i].form.getAttribute('id')][ele[i].getAttribute('data-group')].required.replace(/\{\{([^}]+)\}\}/g, function(i, match) {
          return mapObj[match]}) : '';

          document.getElementById('error-'+ele[i].getAttribute('id')) && 
          document.getElementById('error-'+ele[i].getAttribute('id')).textContent === '' ? document.getElementById('error-'+ele[i].getAttribute('id')).textContent= messagesErrVjs[ele[i].form.getAttribute('id')][ele[i].getAttribute('id')].required.replace(/\{\{([^}]+)\}\}/g, function(i, match) {
          return mapObj[match]}) : '';
      }
  }
...
function iniVJS(){
  for (var i = 0; i < inputsValidar.length; i++) {
    ...
    function maxMinMask(mask){
      ...
      document.getElementById('string-'+mask.getAttribute('id')).textContent='10' : '';

      mask.getAttribute('data-type') === 'countryPhone' ? 
      document.getElementById('string-'+mask.getAttribute('id')).textContent='12' : '';

      mask.getAttribute('data-type') === 'creditCard' ? 
      document.getElementById('string-'+mask.getAttribute('id')).textContent='16' : '';

      mask.getAttribute('data-type') === 'interbankKey' ? 
      document.getElementById('string-'+mask.getAttribute('id')).textContent='18' : '';
...
function validaInput(e) {
  ...
  let validar = new Promise((resolve, reject) => {
    ...
    this.getAttribute('data-type') === 'phone' 
    ? 
    document.getElementById('string-'+this.getAttribute('id')).textContent='10' 
    : 
    '';
    ...
    this.getAttribute('data-type') === 'countryPhone' 
    ? 
    document.getElementById('string-'+this.getAttribute('id')).textContent='12' 
    : 
    '';
    ...
    this.getAttribute('data-type') === 'creditCard' 
    ? 
    document.getElementById('string-'+this.getAttribute('id')).textContent='16' 
    : 
    '';
    ...
    this.getAttribute('data-type') === 'interbankKey' 
    ? 
    document.getElementById('string-'+this.getAttribute('id')).textContent='18' 
    : 
    '';
