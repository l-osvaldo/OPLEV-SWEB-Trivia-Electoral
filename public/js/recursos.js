...
***************************************************************/
  ...
  function getProEsp(pro){
    ...
    document.getElementById("eProgramaEsp").options[document.getElementById("eProgramaEsp").selectedIndex].value == '0' ? (document.getElementById('addAct').style.pointerEvents = 'none',document.getElementById('addAct').style.color = '#cfd8dc'):(document.getElementById('addAct').style.pointerEvents = '',document.getElementById('addAct').style.color = '');
    emptyPrograma();
    $.ajax({
       type:'POST',
       url:"sendporgramaesp",
...
***************************************************************/
  ...
  function changeProEsp(){
    ...
    //console.log(proesp);
    this.options[this.selectedIndex].value == '0' ? (document.getElementById('addAct').style.pointerEvents = 'none',document.getElementById('addAct').style.color = '#cfd8dc'):(document.getElementById('addAct').style.pointerEvents = '',document.getElementById('addAct').style.color = '');
    ///////////////////////////////////////////////////////////////////////////////// ajax de actividades
    $.ajax({
       type:'POST',
       url:"getAct",
...
/*************************************************************
  ...
  Funcionalidad: crea un formulario completo de las actividades de una unidad
  Parametros: Datos del formulario
  Respuesta: crea un documento pdf
